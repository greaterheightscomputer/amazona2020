...
app.use("/api/uploads", uploadRoute); //"/api/uploads" means rout while uploadRoute means respondent 
...
app.use('/uploads', express.static(path.join(__dirname, '/../uploads'))); //__dirname means the currect directory, '/../uploads' means in production mode uploads folder will be inside and serve-up from dist folder like this /dist/uploads
