...
function orderDetailReducer(state = {order: { orderItems: [], shipping: {}, payment: {} }}, action){
    switch (action.type){
...
function orderDeleteReducer(state = {order: { orderItems: [], shipping: {}, payment: {} }}, action){
    switch (action.type){
...
export { orderCreateReducer, orderDetailReducer, orderPayReducer, myOrderListReducer, orderListReducer, orderDeleteReducer };